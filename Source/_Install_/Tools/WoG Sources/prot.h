...
#endif
#define SOD_CRC(X) for(Dword __i=0x400000-__FILENUM__*0x10000-__LINE__,__v=X;__i<((Dword)0x638000-__FILENUM__*0x10000-__LINE__);__i+=4){ __v+=*(Dword *)(__i+__FILENUM__*0x10000+__LINE__+0x1000); } \
__asm lea eax,NoMoreChecksS+__LINE__* 51 +X \
__asm add eax,-__LINE__* 51 -X \
__asm inc ds:[eax] 

#define WOG_CRC(X) for(Dword __i=0x700000-__FILENUM__*0x20000-__LINE__,__v=X;__i<((Dword)(0x782B30-0x1000)-__FILENUM__*0x20000-__LINE__);__i+=4){ __v+=*(Dword *)(__i+__FILENUM__*0x20000+__LINE__+0x1000); } \
