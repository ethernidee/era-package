...
begin
	...
	Era.Hook(Ptr($401B0D), @ADVBUTTONS,                       nil, 0, Era.HOOKTYPE_JUMP); //отрисовка кнопок карты приключений
	Era.Hook(Ptr($403071), @ADVBUTTONS_HINTS_1,               nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам карты приключений при наведении мыши
	Era.Hook(Ptr($402E89), @ADVBUTTONS_HINTS_2,               nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам карты приключений при ПКМ
	Era.Hook(Ptr($404088), @ADVBUTTONS_PlayersColors,         nil, 0, Era.HOOKTYPE_JUMP); //окрашивание кнопок карты приключений в цвета игрока
	Era.Hook(Ptr($5C5C43), @TOWNBUTTONS,                      nil, 0, Era.HOOKTYPE_JUMP); //отрисовка кнопок города
	Era.Hook(Ptr($5C7C03), @TOWNBUTTONS_HINTS_1,              nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам города при наведении мыши
	Era.Hook(Ptr($5D38AD), @TOWNBUTTONS_HINTS_2,              nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам города при кликах
	Era.Hook(Ptr($4DF7B2), @HEROSCREENBUTTONS,                nil, 0, Era.HOOKTYPE_JUMP); //отрисовка кнопок экрана героя
	Era.Hook(Ptr($4DB8ED), @HEROSCREENBUTTONS_HINTS_1,        nil, 0, Era.HOOKTYPE_JUMP); //подсказки к экрана героя при наведении мыши
	Era.Hook(Ptr($4DD839), @HEROSCREENBUTTONS_HINTS_2,        nil, 0, Era.HOOKTYPE_JUMP); //подсказки к экрана героя при ПКМ
	Era.Hook(Ptr($5AE04E), @HEROMETTINGSCREENBUTTONS,         nil, 0, Era.HOOKTYPE_JUMP); //отрисовка кнопок экрана обмена героев
	Era.Hook(Ptr($5B0BDF), @HEROMETTINGSCREENBUTTONS_HINTS_1, nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам экрана обмена героев при наведении мыши
	Era.Hook(Ptr($5B0902), @HEROMETTINGSCREENBUTTONS_HINTS_2, nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам экрана обмена при ПКМ
	Era.Hook(Ptr($46B608), @COMBATBUTTONS,                    nil, 0, Era.HOOKTYPE_JUMP); //Кнопки битвы
	Era.Hook(Ptr($472597), @COMBATBUTTONS_HINTS_2,            nil, 0, Era.HOOKTYPE_JUMP); //подсказки к кнопкам битвы при ПКМ
